...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            header("Location: http://exstake.rf.gd/dashboard/index.php"); // Redirect to the dashboard or any other authenticated page
            exit();
        } else {
...
<body>
    ...
    <form action="#" method="post">
      ...
      <p></p>
      <a href="dashboard/pass">Forgot Password?</a>
        <?php
        if (isset($loginError)) {
